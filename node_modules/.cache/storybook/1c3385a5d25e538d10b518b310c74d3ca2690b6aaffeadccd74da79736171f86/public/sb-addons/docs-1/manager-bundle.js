...
(() => {
  ...
  var ADDON_ID, PANEL_ID, PARAM_KEY, SNIPPET_RENDERED, ERRORS, PolishedError, namedColorMap, hexRegex, hexRgbaRegex, reducedHexRegex, reducedRgbaHexRegex, rgbRegex, rgbaRegex, hslRegex, hslaRegex, reduceHexValue, reduceHexValue$1, isRgb, isRgba, isHsl, isHsla, curriedMix, mix$1, curriedTransparentize, curriedTransparentize$1, Wrapper, EmptyBlock, StyledSyntaxHighlighter, SourceSkeletonWrapper, SourceSkeletonPlaceholder, SourceSkeleton, Source, SourceStyles, init_manager = __esm({
    "node_modules/@storybook/addon-docs/dist/manager.js"() {
      init_define_module();
      init_define_process_env();
      init_define_process_env_NODE_PATH();
      ...
      init_manager_api();
      init_theming();
      ADDON_ID = "storybook/docs", PANEL_ID = `${ADDON_ID}/panel`, PARAM_KEY = "docs", SNIPPET_RENDERED = `${ADDON_ID}/snippet-rendered`;
      ERRORS = { 1: `Passed invalid arguments to hsl, please pass multiple numbers e.g. hsl(360, 0.75, 0.4) or an object e.g. rgb({ hue: 255, saturation: 0.4, lightness: 0.75 }).
...
` };
      ...
      SourceStyles = styled.div(() => ({ height: "100%", [`> :first-child${ignoreSsrWarning}`]: { margin: 0, height: "100%", boxShadow: "none" } }));
    }
  });

  // node_modules/.cache/storybook/1c3385a5d25e538d10b518b310c74d3ca2690b6aaffeadccd74da79736171f86/sb-manager/docs-1/manager-bundle.js
